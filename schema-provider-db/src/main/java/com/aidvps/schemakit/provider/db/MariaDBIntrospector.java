...
/** MariaDB-specific database introspection enhancements. */
public class MariaDBIntrospector implements PlatformIntrospector {
    ...
    public String getTableType(
            ...
            throws SQLException {
        // MariaDB-specific table type detection
        return "TABLE";
    }
    ...
    public String getColumnSpecialType(
            ...
            String columnName)
            throws SQLException {
        // MariaDB-specific column type detection
        return null;
    }

    @Override
    public String normalizeDataType(String dataType) {
        // Normalize MariaDB-specific type names
        if (dataType == null) {
            return null;
        }
        String normalized = dataType.toUpperCase();
        // MariaDB is largely compatible with MySQL types
